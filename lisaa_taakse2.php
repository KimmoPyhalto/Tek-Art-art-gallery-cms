		...
		<div class="main">
			...
			if (isset( $_POST["polku"])) //Asiaosuuden muokkaus ja kirjoitus
				{
				$uus1rowid = $rowid + 1;
				array_splice($lines, $uus1rowid, 0, $_POST["polku"]."|".$_POST["otsikko"]."|".$_POST["asia1"]."|".$_POST["asia2"]."|".$_POST["asia3"]."|".$_POST["asia4"]."|".$_POST["kuva1"]."|".$_POST["kuva2"]."|".$_POST["kuva3"]."|".$_POST["kuva4"]);
			...
			if ($status == 1) //Alinavin muokkaus ja uudelleenkirjoitus HUOM. Tässä kuuluu normaalisti olla numero 1
				...
				$uus2rowid1 = $rowid * 2; //Lisätään oikeaan paikkaan
				array_splice($stack, $uus2rowid1, 0, $_POST["kuva1"]);  
				$uus2rowid2 = $uus2rowid1 + 1;
				array_splice($stack, $uus2rowid2, 0, $_POST["alanaviotsikko"]); 
