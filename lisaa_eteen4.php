		...
		<div class="main">
			...
			if ($status == 1) //Alinavin muokkaus ja uudelleenkirjoitus HUOM. Tässä kuuluu normaalisti olla numero 1
				...
				array_splice($stack, $uusrowid2, 0, $_POST["alinavinteksti"]);  
			...
			<form method="POST">
				...
				Alinavin teksti: <br /><input type="text" name="alinavinteksti"><br />
